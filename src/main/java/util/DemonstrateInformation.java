...
public class DemonstrateInformation {
    ...
    public void demonstrateTaskInfo(List<Task> tasks) {
        ...
        int dashLength = statusSize + createDateSize + lastUpdateSize + descriptionSize + titleSize + contentSize + 41;
    ...
    private void printTaskHeader(int dashLength,
        ...
        System.out.format("|%" + (-(contentSize + 10)) + "s", "content");
    ...
    private void printTaskInfo(List<Task> tasks, int titleSize,
        ...
        for (Task task : tasks) {
            ...
            System.out.format("|%" + (-(contentSize + 10)) + "s", task.getContent());
